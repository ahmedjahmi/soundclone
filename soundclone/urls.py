...
urlpatterns = [
    ...
    path('playlists/create', views.playlist_create_view, name='playlist-create'),
    path('playlists/<int:pk>', views.playlist_detail_view, name='playlist-detail'),
    path('playlists/<int:playlist_pk>/add-track/<int:track_pk>', views.playlist_add_track_view, name='playlist-add-track'),
